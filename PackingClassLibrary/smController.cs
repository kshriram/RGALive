...
namespace PackingClassLibrary
{
    ...
    public class smController
    {
        ...
        //public List<cstShippingTbl> GetShippingTblWithPackage()
        //{
        //    cmdShipping commnad = new cmdShipping();
        //    return commnad.GetShippingWithPackage();
        //}


        public List<cstPackageBoxTracking> GetPackageBoxTrackingBySHO(String ShipmentNumber)
        {
            cmdPackageBoxTracking commands = new cmdPackageBoxTracking();
            return commands.GetPackageBoxTracking(ShipmentNumber);
        }

        public List<cstShipmentDetailPageGrid1> GetShipmentDetailPageGrid1ByDate(String Date)
        {
            cmdShipmentDetailPageGrid1 commands = new cmdShipmentDetailPageGrid1();
            return commands.GetShipmentDetailPageGrid1(Date);
        }

        public List<cstShipmentDetailPageGrid1> GetShipmentDetailPageGrid1ByDateTotal(String Date)
        {
            cmdShipmentDetailPageGrid1 commands = new cmdShipmentDetailPageGrid1();
            return commands.GetShipmentDetailPageGrid1Total(Date);
        }


        public List<cstShipmentDetailPageGrid1> GetShipmentDetailPageGrid1ByDateSearch(String Date1, String Date2)
        {
            cmdShipmentDetailPageGrid1 commands = new cmdShipmentDetailPageGrid1();
            return commands.GetShipmentDetailPageGrid1SearchByDates(Date1, Date2);
        }

        public List<cstShipmentDetailPageGrid1> GetShipmentDetailPageGrid1ByDateSearchExpecteds(String Date1, String Date2)
        {
            cmdShipmentDetailPageGrid1 commands = new cmdShipmentDetailPageGrid1();
            return commands.GetShipmentDetailPageGrid1ByDateSearchExpected(Date1, Date2);
        }

        //public List<cstShipmentInformationAlls> GetPackageWithBox()
        //{
        //    cmdShipmentInformationAll commands = new cmdShipmentInformationAll();
        //    return commands.GetPackageWithBox();
        //}
        ...
        public List<cstShippingTbl> GetShippingInfoFromSage(String ShippingNumber)
        {
            cmdSageOperations command = new cmdSageOperations();
            return command.getShippingInfo(ShippingNumber);
        }
