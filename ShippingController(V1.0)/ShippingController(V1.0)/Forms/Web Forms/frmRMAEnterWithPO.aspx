        ...
        <div style="margin: 0px 170px">
            <table style="width: 1250px;">
              <%--  <tr>
                ...
                <tr>
                    <td class="TitleStrip" style="width: 100%">
                ...
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                   ...
                   <%--  <asp:Label ID="lblUserName" runat="server" Text="" Font-Bold="true" ForeColor="White"></asp:Label>--%>
                    ...
                    <asp:Button ID="btnSaveHeader" runat="server" Text="Save" CssClass="btnmaker" OnClick="btnConfirmBox_Click"></asp:Button>
                          <%-- <asp:Button ID="Button1" runat="server" Text="Save" CssClass="btnmaker" OnClick="btnSaveHeader_Click1"/>--%>
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                       <%--<asp:Button ID="btnCancelHeader" runat="server" Text="Cancel" CssClass="btnmaker" OnClick="btnCancelHeader_Click" />--%>
                       ...
                       <%--  <asp:Button ID="btnCancelHeader" runat="server" Text="Cancel" CssClass="btnmaker" OnClientClick="javascript:return confirm('You want to exit without saving the records');" OnClick="btnOk_Click" /> --%>
                          <asp:Button ID="btnCancelHeader" runat="server" Text="Cancel" CssClass="btnmaker" OnClick="btnCancelBox_Click"/>
                     </ContentTemplate>
                                   <Triggers>
                ...
                <tr>
                    <td class="auto-style2">
                        <div class="border" style="width: 1250px">
                            <asp:UpdatePanel ID="updatePanelbtnComment" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                    ...
                                    <table id="tblmain" runat="server" style="width: 100%; padding: 2px;" class="border">
                                        <tr>
                                            <td class="tdLeft" style="width:11%">
                                                <asp:Label ID="lblRGAnumber" runat="server" Text="RGA " CssClass="lbl"></asp:Label>
                                            </td>
                                            <td style="width:13%">
                                                <asp:TextBox ID="txtrganumber" runat="server" ReadOnly="true" ForeColor="Red" Enabled="false"></asp:TextBox>
                                            </td>
                                            <td class="tdLeft" style="width:11%">
                                            ...
                                            <td class="auto-style1" colspan="2" Style="text-align:center;vertical-align:middle; width:20%">
...
<asp:TextBox CssClass="txt" ID="TextBox3" runat="server" ReadOnly="true"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td rowspan="4" class="auto-style1" Style="text-align:center;vertical-align:middle;">
                                                <asp:TextBox ID="txtcomment" Style="margin:-25 0 0 0; max-height:100px;min-height: 100px;max-width:200px;min-width:200px;" runat="server" TextMode="MultiLine" Height="80" Width="180px"></asp:TextBox>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtRMAnumber" runat="server" ForeColor="Red" ReadOnly="true"></asp:TextBox>
                                            </td>
                                            <td class="tdLeft">
                                                <asp:Label ID="Label2" runat="server" Text="Customer Name" CssClass="lbl"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtcustomerName" runat="server" Enabled="false" OnTextChanged="txtcustomerName_TextChanged"></asp:TextBox>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style1" Style="text-align:center;vertical-align:middle;">
                                                <asp:Button ID="btnComment" Style="margin-left: -10px" runat="server" CssClass="btnmaker" Visible="true" Width="120" Text="Add Comment" OnClick="btnComment_Click" />
                                            </td>
                                            <%--<td style="width:10%">
...
<asp:TextBox CssClass="txt" ID="TextBox5" runat="server" ReadOnly="true" Enabled="false"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td colspan="10" height="50">
                                                ...
                                                &nbsp&nbsp&nbsp&nbsp
                                <asp:TextBox ID="TextBox1" runat="server" Width="1025px"></asp:TextBox>
                                                &nbsp&nbsp&nbsp&nbsp
                                <asp:CheckBox ID="chkflag" Text="Flag" Font-Bold="true" Font-Size="20" runat="server" ForeColor="Black" OnCheckedChanged="chkflag_CheckedChanged" />
                                            </td>
                                            <%--<td colspan="3" >
        ...
        <div style="margin: 0px 12px; width: 1555px;">
            <table style="width: 1250px;">
                ...
                <%--    <asp:Button ID="BtnDeleteNewItem" runat="server" Text="Delete" Visible="false" CssClass="btnmaker" />--%>
                                                    </td>
                                                </tr>
                                            </table>
                                        </ContentTemplate>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <asp:GridView ID="gvReturnDetails" Width="100%" ShowHeader="False" runat="server" HorizontalAlign="Center"  AutoGenerateColumns="False" 
                                                        ...
                                                        ForeColor="Black" AllowSorting="True" OnRowDeleting="gvReturnDetails_RowDeleting" OnSelectedIndexChanged="gvReturnDetails_SelectedIndexChanged" EmptyDataText="No Any SKU">
                                                        <RowStyle  Height="54px"/>
                                                        <Columns>
...
<ItemStyle Width="100px" />
                                                            ...
                                                            <asp:TemplateField HeaderText="SKU">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtSKU" runat="server" Text='<%# Eval("SKUNumber") %>' AutoPostBack="True" ReadOnly="true"></asp:TextBox>
                                                                    <%--<asp:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server"
                                                                        ServiceMethod="SearchSKUNumber"
                                                                        MinimumPrefixLength="1"
                                                                        ServicePath="~/Forms/Web Forms/AutoCompleteService.aspx"
                                                            ...
                                                            <asp:TemplateField HeaderText="Qty">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtSKU_Qty_Seq" runat="server" Text='<%#Eval("SKU_Qty_Seq") %>' ReadOnly="True"></asp:TextBox>
                                                                </ItemTemplate>
...
<ItemStyle Width="100px" />
                                                            ...
                                                            <asp:TemplateField HeaderText="ProductID" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtProductID" runat="server" Text='<%#Eval("ProductID") %>' Enabled="false"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                          ...
                                                          <%--  <asp:TemplateField HeaderText="Sales Price" Visible="false">
                                                            ...
                                                            <asp:TemplateField HeaderText="Upload Images(jpg/jpeg)">
                                                                <ItemTemplate>
                                                                    <asp:FileUpload ID="FileUpload1" runat="server" OnLoad="FileUpload1_Load1" AllowMultiple="true" Enabled="false" />
                                                                 
                                                                    <asp:Button ID="btnUpdate" runat="server" Text="Upload Image" OnClick="btnUpdate_Click1" Visible="false" />
                                                            ...
                                                            <asp:TemplateField HeaderText="LT" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtLineType" runat="server" Text='<%#Eval("LineType") %>' Enabled="false"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ControlStyle Width="100px" />
                                                                <ItemStyle Width="100px" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="SL" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtShipmentLines" runat="server" Text='<%#Eval("ShipmentLines") %>' Enabled="false"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ControlStyle Width="100px" />
                                                                <ItemStyle Width="100px" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="RL" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtReturnLines" runat="server" Text='<%#Eval("ReturnLines") %>' Enabled="false"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ControlStyle Width="100px" />
                                                                <ItemStyle Width="100px" />
                                                               
                                                    
<%--                                                        </asp:TemplateField><asp:TemplateField HeaderText="Delete">
                                                           <ItemTemplate>    
                                                         <span onclick="return confirm('Are you sure want to delete?')">
                                                             <asp:Button ID="Button19" runat="server" Text="Delete" />
                                                              ...
                                                              <asp:TemplateField HeaderText="Tracking Number" Visible="true">
                                                                <ItemTemplate>
                                                                    <asp:Panel ID="Panel1" runat="server" DefaultButton="SubmitButton">
                                                                             <asp:TextBox ID="txtTrackingNumber"  Width="140px" runat="server" Text='<%#Eval("TrackingNumber") %>' Enabled="false" ></asp:TextBox>
    ...
    <ItemTemplate>
       ...
       <asp:LinkButton ID="LinkButton1" 
         CommandArgument='<%# Eval("ReturnLines") %>' 
         ...
         Delete</asp:LinkButton>
                                 ...
                                 <ContentTemplate>
                              <span onclick="return confirm('Are you sure want to delete?')">
                              <asp:LinkButton ID="btnDelete" Text="Remove SKU" runat="server" Height="20px" ForeColor="white" Font-Underline="false" BorderStyle="Groove" BackColor="#5998ff" CommandName="Delete" OnClientClick="javascript:CheckOtherIsCheckedByGVID(this);" />
                                </span>
          ...
          EventName = "Click" />--%>
                        ...
                        <table style="width: 550px;">
                                            ...
                                            <td>
                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                                                    <ContentTemplate>
                                                        ...
                                                        <table id="Table1" class="border" style="width: 550px;" runat="server" name="tblm">
                                                            <tr>
                                                                <td colspan="5">
                                                                    <table style="width: 100%">
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 30%">
                                                                                ...
                                                                                <asp:RadioButtonList ID="brdItemNew" runat="server" CssClass="RadioButtonforReasons" RepeatDirection="Horizontal" Width="300px" AutoPostBack="true" OnSelectedIndexChanged="brdItemNew_SelectedIndexChanged">
                                                                    ...
                                                                    <table style="width: 100%">
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 30%">
                                                                                ...
                                                                                <asp:RadioButtonList ID="brdstatus" runat="server" CssClass="RadioButtonforReasons" RepeatDirection="Horizontal" Width="300px" AutoPostBack="true" OnSelectedIndexChanged="brdstatus_SelectedIndexChanged">
                                                                                    <asp:ListItem>Yes</asp:ListItem>
                                                                                    <asp:ListItem>No</asp:ListItem>
                                                                                </asp:RadioButtonList>
                           ...
                           <asp:CheckBox ID="CheckBox4" Text="Received wrong item." runat="server" CssClass="lbl"/>
                                                                    ...
                                                                    <table style="width: 100%">
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 30%">
                                                                                ...
                                                                                <asp:RadioButtonList ID="brdManufacturer" CssClass="RadioButtonforReasons" runat="server" RepeatDirection="Horizontal" Width="300px" AutoPostBack="true" OnSelectedIndexChanged="brdManufacturer_SelectedIndexChanged">
                                                                                    <asp:ListItem>Yes</asp:ListItem>
                                                                                    <asp:ListItem>No</asp:ListItem>
                                                                                </asp:RadioButtonList>
                            ...
                            <asp:CheckBox ID="CheckBox6" Text="Received wrong item." runat="server" CssClass="lbl"/>
                                                                    ...
                                                                    <table style="width: 100%">
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 30%">
                                                                                ...
                                                                                <asp:RadioButtonList ID="brdDefecttransite" CssClass="RadioButtonforReasons" runat="server" RepeatDirection="Horizontal" Width="300px" AutoPostBack="true" OnSelectedIndexChanged="brdDefecttransite_SelectedIndexChanged">
                                                                                    <asp:ListItem>Yes</asp:ListItem>
                                                                                    <asp:ListItem>No</asp:ListItem>
                                                                                </asp:RadioButtonList>
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                <td class="tdLeft" style="vertical-align: middle; text-align: center;">
            ...
            <div style="width: 1250px; height: 50px;">
                <table style="width: 100%">
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <asp:Button ID="btnupdate" runat="server" Text="Save" CssClass="btnmaker" OnClick="btnConfirmBox_Click" />
                                         <asp:Button ID="Button1" runat="server" Text="Cancel" CssClass="btnmaker" OnClick="btnCancelBox_Click"/>
                                       </ContentTemplate>
                                   <Triggers>
                           ...
                           <%-- <asp:Button ID="btncancle" runat="server" Text="Cancel" CssClass="btnmaker" OnClientClick="javascript:return confirm('You want to exit without saving the records');" OnClick="btnOk_Click" />--%>
            ...
            <table width="100%" style="border: Solid 2px #D46900; background-color: white; width: 100%; height: 100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="right" style="padding-right: 15px" backcolor="White">
                        <asp:LinkButton ID="lnkSaveCont" runat="server" Font-Bold="True" Font-Size="15px" PostBackUrl="~/Forms/Web Forms/frmRMAEnterWithPO.aspx">Save&Continue</asp:LinkButton>
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
   <asp:LinkButton ID="lnkSaveex" runat="server" Font-Bold="True" Font-Size="15px" PostBackUrl="~/Forms/Web Forms/DemoGrid.aspx">Save&Exit</asp:LinkButton>
        ...
        <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="142px" Width="400px" Style="display: none">
           ...
           <asp:Button ID="Button23" runat="server" Text="Button" Style="display: none" />
                    <asp:Panel ID="pnlForCancel1" runat="server" CssClass="modalPopup" Style="display: none">
                        <div class="header">
                            
                        </div>
                        <div class="body" style="color: red">
                            <asp:Label ID="Label5" runat="server" Text="Do you want to exit without saving??????"></asp:Label>
                        </div>
                        <div class="footer" align="center">
                            <asp:Button ID="btnYesForCancel1" runat="server" Text="Yes" onClick="btnYesForCancel_Click1"/>
                            <%--<asp:Button ID="btnNoPO" runat="server" Text="No" OnClick="btnNoPO" />--%>
                            <asp:Button ID="btnNOForCancel1" runat="server" Text="No" />
                        </div>
                    </asp:Panel>
                    <cc1:ModalPopupExtender ID="mpeForCancel1" runat="server" PopupControlID="pnlForCancel1"
                        Enabled="True" TargetControlID="Button23" CancelControlID="btnNoForCancel1">
                    </cc1:ModalPopupExtender>
          <%--foraddnew--%>

           <asp:Button ID="Button30" runat="server" Text="Button" Style="display: none" />
                    <asp:Panel ID="pnlFor" runat="server" CssClass="modalPopup" Style="display: none">
                        <div class="header">
                            
                        </div>
                        <div class="body" style="color: red">
                            <asp:Button ID="Button2" runat="server" Text="Add new product with PO" />
                            <asp:Button ID="btnNoForCan" runat="server" Text="Add Product Of Non PO" />
                        </div>
                        <div class="footer" align="center">
                           <%-- <asp:Button ID="Button3" runat="server" Text="Yes" onClick="btnYesForCancel_Click1"/>
                            <%--<asp:Button ID="btnNoPO" runat="server" Text="No" OnClick="btnNoPO" />--%>
                            <%--<asp:Button ID="btnNoForCan" runat="server" Text="No" />--%>
                        </div>
                    </asp:Panel>
                    <cc1:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="pnlFor"
                        Enabled="True" TargetControlID="Button30" CancelControlID="btnNoForCan">
                    </cc1:ModalPopupExtender>

<%--           <asp:Button ID="Button21" runat="server" Text="Button" Style="display: none" />
                    <asp:Panel ID="pnlForSave" runat="server" CssClass="modalPopup" Style="display: none">
                        <div class="header">
                            
                        </div>
                        <div class="body" style="color: red">
                            <asp:Label ID="Label9" runat="server" Text="Do you want to Save?????"></asp:Label>
                        </div>
                        <div class="footer" align="center">
                            <asp:Button ID="btnYesForSave" runat="server" Text="Yes" onClick="btnUpdate_Click1"/>
                            <%--<asp:Button ID="btnNoPO" runat="server" Text="No" OnClick="btnNoPO" />
                            <asp:Button ID="btnNoForSave" runat="server" Text="No" />
                        </div>
                    </asp:Panel>
                    <cc1:ModalPopupExtender ID="mpeForSave" runat="server" PopupControlID="pnlForSave"
                        Enabled="True" TargetControlID="Button21" CancelControlID="btnNoForSave">
                    </cc1:ModalPopupExtender>--%>
        ...
        <asp:Panel ID="pnlPopupForAddYes" runat="server" CssClass="modalPopup" Style="display: none">
            ...
            <div class="body" style="color: red">
                <asp:Label ID="lblPopUpForAddYes" runat="server" Text="SKU'S is Added successfully. "></asp:Label>
            </div>
            <div class="footer" align="center">
        ...
        <asp:Panel ID="pnlPopupForCommentYes" runat="server" CssClass="modalPopup" Style="display: none">
            ...
            <div class="body" style="color: red">
                <asp:Label ID="lblPopupForCommentYes" runat="server" Text="You want to select from gridview. Go Ahead."></asp:Label>
            </div>
            <div class="footer" align="center">
        ...
        <cc1:ModalPopupExtender ID="mpePopupForSaveYes" runat="server" BackgroundCssClass="modalBackground" PopupControlID="pnlPopupForSaveYes"
            ...
            <asp:Panel ID="pnlCommentYes" runat="server" CssClass="modalPopup" Style="display: none">
                <div class="header">
                    Message Box
                </div>
                <div class="body" style="color: red">
                    <asp:Label ID="lblForComment" runat="server" Text="Comment Added successfully. Go Ahead."></asp:Label>
                </div>
                <div class="footer" align="center">
                    <asp:Button ID="btnOkCommentYes" runat="server" Text="Ok" />
                </div>
            </asp:Panel>
            <cc1:ModalPopupExtender ID="MpeForComment" runat="server" BackgroundCssClass="modalBackground" PopupControlID="pnlCommentYes"
                Enabled="True" TargetControlID="Button18" OkControlID="btnOkCommentYes">
            </cc1:ModalPopupExtender>
       <%-- <asp:Button ID="Button12" runat="server" Text="Button" Style="display: none" />
        ...
        <asp:Panel ID="pnlPopupForSaveNo" runat="server" CssClass="modalPopup" Style="display: none; width:auto">
            ...
            <div class="body" style="color: red">
                <asp:Label ID="lblPopupForSaveNo" runat="server" Text=""></asp:Label>
            </div>
            <div class="footer" align="center">
            ...
            <asp:Button ID="Button3" runat="server" Text="Button" Style="display: none" />
                            <asp:Panel ID="pnlForPO" runat="server" CssClass="modalPopup" Style="display: none">
                              ...
                              Add New Product
                                ...
                                <div class="body" style="color: red">
                                   <asp:Label ID="Label9" runat="server" Text="By Which You Want To Add Product????"></asp:Label>
                                </div>
                                <div class="footer" align="center">
                                    <asp:Button ID="btnYesPO" runat="server" Text="Add With PO" OnClick="btnAddPO_click"/>
                                    <%--<asp:Button ID="btnNoPO" runat="server" Text="No" OnClick="btnNoPO" />--%>
                                    <asp:Button ID="btnNoPO" runat="server" Text="Add With Non PO" OnClick="btnNonPO_Click"/>
                                </div>
                            </asp:Panel>

                            <cc1:ModalPopupExtender ID="mpeForaddPO" runat="server" BackgroundCssClass="modalBackground" PopupControlID="pnlForPO"
                                Enabled="True" TargetControlID="Button3" CancelControlID="btnYesPO">
                            </cc1:ModalPopupExtender>

         <%--  After add new Product with po--%>

           <asp:Button ID="Button16" runat="server" Text="Button" Style="display: none" />
        <asp:Panel ID="pnlGridYes" runat="server" CssClass="modalPopup" Style="display: none">
            <div class="header">
                Message Box
            </div>
            <div class="body" style="color: red">
                <asp:Label ID="Label10" runat="server" Text="You need to select from gridview."></asp:Label>
            </div>
            <div class="footer" align="center">
                <asp:Button ID="btnOkGridYes" runat="server" Text="Ok" />
            </div>
        </asp:Panel>
        <cc1:ModalPopupExtender ID="ModalPopupForGrid" runat="server" BackgroundCssClass="modalBackground" PopupControlID="pnlGridYes"
            Enabled="True" TargetControlID="Button16" OkControlID="btnOkGridYes">
        </cc1:ModalPopupExtender>

          
        <asp:Button ID="Button120" runat="server" Text="Button" Style="display: none" />
        <asp:Panel ID="pnlForNonBitMap" runat="server" CssClass="modalPopup" Style="display: none">
            <div class="header">
                Message Box
            </div>
            <div class="body" style="color: red">
                <asp:Label ID="Label11" runat="server" Text="Use the TextBox,Type SKU and click add"></asp:Label>
            </div>
            <div class="footer" align="center">
                <asp:Button ID="btnOkForNonBitMap" runat="server" Text="Ok" />
            </div>
        </asp:Panel>
        <cc1:ModalPopupExtender ID="ModalPopupBitMap" runat="server" BackgroundCssClass="modalBackground" PopupControlID="pnlForNonBitMap"
            Enabled="True" TargetControlID="Button120" OkControlID="btnOkForNonBitMap">
        </cc1:ModalPopupExtender>
        ...
        <asp:Panel ID="Panel2" runat="server" CssClass="modalPopup" Style="display: none">
            ...
            <div class="body" style="color: red">
                <asp:Label ID="pnlPopupForNonPO" runat="server" Text="You need to go Add Button!!!!!!"></asp:Label>
            </div>
            <div class="footer" align="center">
                <asp:Button ID="btnOkForNonPO" runat="server" Text="Ok"  />
            </div>
        </asp:Panel>
        <cc1:ModalPopupExtender ID="ModalPopupFORNonPO" runat="server" BackgroundCssClass="modalBackground" PopupControlID="pnlPopupForNonPO"
            Enabled="True" TargetControlID="Button17" OkControlID="btnOkForNonPO">
        </cc1:ModalPopupExtender>
    ...
    --%>
       ...
       <%-- <ItemTemplate>
            <asp:CheckBox ID="chkSelectRow" runat="server" TextAlign="Left"  onclick="CheckRow(this);" />
                                 ...
                                 <div class="footer" align="center">
                                    <asp:Button ID="Button12" runat="server" CssClass="btnmaker" Text="Next" OnClick="btnAddGrid2"/>
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
