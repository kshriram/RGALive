...
<asp:TextBox CssClass="txt" ID="TextBox5" runat="server" ReadOnly="true" Enabled="false"></asp:TextBox>
                ...
                <div style="margin: 0px 12px; width: 1555px;">
                 ...
                 <asp:Button ID="btnaddnew" runat="server" Text="Add new product" CssClass="btnmaker" OnClick="btnaddnew_Click1" Width="135px" />
                                                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                ...
                <asp:Button ID="BtnAddNewItem" runat="server" CssClass="btnmaker" Text="Add" Visible="false" OnClick="BtnAddNewItem_Click" />
                                                                </td>
                                                            </tr>
                                                        </table>
...
<ItemStyle Width="100px" />
                                                                    ...
                                                                    <asp:TemplateField HeaderText="No. of images">
                                                                        <ItemTemplate>
                                                                            <%--<asp:LinkButton ID="LinkButton1" runat="server" Text='<%#Eval("NoofImages") %>' OnClick="txtImageCount_Click" Enabled="false"></asp:LinkButton>--%>
                                                    ...
                                                    <table style="width: 100%">
                                                        <tr>
                                                            ...
                                                            <td style="width: 30%">
                                                                ...
                                                                <asp:RadioButtonList ID="brdstatus" ForeColor="Black" CssClass="RadioButtonforReasons" runat="server" RepeatDirection="Horizontal" Width="300px" AutoPostBack="true">
                                                                    <asp:ListItem>Yes</asp:ListItem>
                                                                    <asp:ListItem>No</asp:ListItem>
                                                                </asp:RadioButtonList>
                                            ...
                                            <tr>
                                                <td colspan="5">
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td style="width: 30%">
                                                                <asp:Label ID="lblDefectintransite" ForeColor="Black" Text="Defect in Transit" runat="server" CssClass="lbl" />
                                                            </td>
                                                            <td style="width: 30%">
                    ...
                    <div style="height: 50px;" align="center">
                        ...
                        <asp:UpdatePanel ID="updatePanel5" runat="server" UpdateMode="Always">
                            <ContentTemplate>
                                ...
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                  <%-- <asp:Button ID="Button2" runat="server" Text="Cancel" CssClass="btnmaker" OnClick="btnCancelHeader_Click" />--%>
                                <asp:Button ID="Button2" runat="server" Text="Cancel" CssClass="btnmaker" OnClientClick="javascript:return confirm('You want to exit without saving the records');" OnClick="btnOk_Click" />
   ...
   <asp:LinkButton ID="lnkSaveex" runat="server" Font-Bold="True" Font-Size="15px" PostBackUrl="~/Forms/Web Forms/DemoGrid.aspx">Save&Exit</asp:LinkButton>
                    ...
                    <asp:Panel ID="Panel2" runat="server" CssClass="modalPopup" Style="display: none">
                        ...
                        <div class="body" style="color: red">
                            <asp:Label ID="Label9" runat="server" Text="Do you want to exit without saving??????"></asp:Label>
                        </div>
                        <div class="footer" align="center">
                            <asp:Button ID="Button16" runat="server" Text="Yes" OnClick="btnYesForCancel_Click" />
                            <%--<asp:Button ID="btnNoPO" runat="server" Text="No" OnClick="btnNoPO" />--%>
                            <asp:Button ID="Button17" runat="server" Text="No" />
                        </div>
                    </asp:Panel>
                    <cc1:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="Panel2"
                        Enabled="True" TargetControlID="Button3" CancelControlID="btnNoForCancel">
                    </cc1:ModalPopupExtender>
                    ...
                    <asp:Panel ID="pnlForDemoGrid" runat="server" CssClass="modalPopup" Style="display: none">
                        <div class="header">
                            Message Box
                        </div>
                        <div class="body" style="color: red">
                            <asp:Label ID="lblForDemoGrid" runat="server" Text="Your Data saved successfully."></asp:Label>
                        </div>
                        <div class="footer" align="center">
                            <asp:Button ID="btnOkForDemoGrid" runat="server" Text="Ok" OnClick="btnOkForDemoGrid_Click" />
                        </div>
                    </asp:Panel>
                    <cc1:ModalPopupExtender ID="mpeForDemoGrrid" runat="server" BackgroundCssClass="modalBackground" PopupControlID="pnlForDemoGrid"
                        Enabled="True" TargetControlID="Button114" OkControlID="btnOkForDemoGrid">
                    </cc1:ModalPopupExtender>
                    ...
                    <asp:Panel ID="pnlConfirmBox" runat="server" CssClass="modalPopup" Style="display: none">
                        ...
                        <div class="footer" align="center">
                           <%-- <asp:UpdatePanel ID="updatePanel4" runat="server" UpdateMode="Always">
                                <ContentTemplate>--%>
                                    <asp:Button ID="btnConfirmYes" runat="server" Text="Yes" OnClick="btnsave_Click" />
